...
product1 = Product.create!(name: "coffee", price: 1, description: "Sumatra blend Aribica dark roast", supplier_id: 1, inventory: 99)

product2 = Product.create!(name: "tea", price: 2, description: "grean tea from China", supplier_id: 1, inventory: 98)

product3 = Product.create!(name: "soda", price: 3, description: "refreshing beverage", supplier_id: 2, inventory: 90)
